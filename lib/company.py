...
class Company():
    ...
    @classmethod
    def create_company(cls, company_id: int, db_connection: mysql.connector.MySQLConnection, hq_street: str, hq_city: str, hq_state: str, hq_zip: int, hq_phone_area: int, hq_phone_number: int, hq_fax_area: int, hq_fax_number: int, license_number: int, agent_ids: list):
        #Insert a company
