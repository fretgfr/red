...
class Listing:
    ...
    def update_listing(self, db_connection: mysql.connector.MySQLConnection):
        with db_connection.cursor() as cursor:
            cursor.execute("UPDATE LISTING SET listing_type = %s, listing_status = %s, listing_description = %s, listing_sale_yn = %s, listing_rent_yn = %s, listing_price = %s, listing_original_price = %s, listing_address_number = %s, listing_address_street = %s, listing_address_city = %s, listing_address_state = %s, listing_address_zip = %s, listing_structure_style = %s, listing_bedroom_count = %s, listing_full_bathroom_count = %s, listing_half_bathroom_count = %s, listing_basement_yn = %s, listing_waterfront_yn = %s, listing_fireplace_yn = %s, listing_garage_yn = %s, listing_pool_yn = %s, listing_ownership = %s, listing_school_district = %s, listing_garage_car_count = %s, listing_above_grade_sqft = %s, listing_acreage = %s, listing_year_built = %s, listing_date_listed = %s, listing_agent_license_number = %s, listing_colisting_agent_license_number = %s, listing_image_links = %s WHERE listing_mls_number = %s", (self.listing_type, self.listing_status, self.listing_description, self.listing_sale_yn, self.listing_rent_yn, self.listing_price, self.listing_price, self.listing_address_number, self.listing_address_street, self.listing_address_city, self.listing_address_state, self.listing_address_zip, self.listing_structure_style, self.listing_bedroom_count, self.listing_full_bathroom_count, self.listing_half_bathroom_count, self.listing_basement_yn, self.listing_waterfront_yn, self.listing_fireplace_yn, self.listing_garage_yn, self.listing_pool_yn, self.listing_ownership, self.listing_school_district, self.listing_garage_car_count, self.listing_above_grade_sqft, self.listing_acreage, self.listing_year_built, self.listing_date_listed, self.listing_agent_license_number, self.listing_colisting_agent_license_number, self.listing_image_link, self.listing_mls_number))
            db_connection.commit()
        return self
