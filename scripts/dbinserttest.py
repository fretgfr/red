...
with db_connection.cursor() as cursor:
    results = cursor.execute("""
        ...
        VALUES ("Single Family", "Active", "A BEAUTIFUL HOUSE", 1, 0, 150000, 150000, 123, "Main St", "Rochester Hills", "MI", 48309, "Ranch", 3, 1, 1, 1, 0, 1, 1, 0, "Private", "Rochester Public Schools", 2, 1390, %s, 2010, %s, 1, 1, "https://google.com")""", (Decimal("0.25"), date.today()))
